...
<div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
            ...
            <div className="bg-lamaSky py-6 px-2 rounded-md flex flex-1 gap-4">
                <div className="w-1/3">
                    <Image
                        ...
                        alt="" width={130} height={10} className="w-36 h-36 rounded-full object-cover" />
                </div>
    ...
    <div className="bg-white p-4 rounded-md">
      ...
      <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
        <Link className="p-3 rounded-md bg-lamaSkyLight" href="/absen">Absensi</Link>
        <Link className="p-3 rounded-md bg-LamaPurpleLight" href="/cuti">Pengajuan Cuti</Link>
        <Link className="p-3 rounded-md bg-LamaYellowLight" href="/lembur">Pengajuan Lembur</Link>
